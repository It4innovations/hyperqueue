...
def test_job_no_pin(hq_env: HqEnv):
    ...
    table.print()
    table.check_row_value("State", "FINISHED")
    table.check_row_value("Resources", "2 compact!")
...
def test_job_pin(hq_env: HqEnv):
    ...
    table.print()
    table.check_row_value("State", "FINISHED")
    table.check_row_value("Resources", "2 compact! [pin]")
